                ...
                <div class="">
                    ...
                    <div id="indicators-carousel" class="relative w-full" data-carousel="static">
                        ...
                        <button type="button"
                            ...
                            data-carousel-prev>
                            <span
                                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-amber-50 group-hover:bg-amber-500 dark:group-hover:bg-amber-500 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
